          ...
          >
            ...
            <div className="flex flex-col flex-row gap-8 mt-12 mb-16">
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-pink-400">Color Palettes</h3>
                <div className="feature-card-arrow">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                  </svg>
        ...
        <div className="relative w-full h-full">
          {!localSplineLoaded && (
            <motion.div
              ...
              initial={{ opacity: 1 }}
              animate={{ opacity: localSplineLoaded ? 0 : 1 }}
              transition={{ duration: 0.5 }}
            >
          ...
          >
              <Spline
                ...
                onError={(err) => {
                  console.error('Background Spline loading error:', err);
                  setLocalSplineLoaded(true);
                  setSplineLoaded(true);
                }}
              />
            <ErrorBoundary fallback={ null }>
              <Spline 
                ...
                onError={(err) => {
                  console.error('Foreground Spline loading error:', err);
                  setLocalSplineLoaded(true);
                  setSplineLoaded(true);
                }}
